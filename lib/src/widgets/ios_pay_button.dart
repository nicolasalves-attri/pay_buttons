...
class _UiKitApplePayButton extends StatelessWidget {
  ...
  final ApplePayButtonStyle style;
  final ApplePayButtonType type;
  final String kButtonChannel = 'br.com.attri/pay_buttons_channel';
  ...
  Widget build(BuildContext context) {
    return UiKitView(
      ...
      creationParams: <String, dynamic>{'style': style.enumString, 'type': type.enumString},
      onPlatformViewCreated: (int viewId) {
        final MethodChannel methodChannel = MethodChannel('$kButtonChannel/$viewId');
